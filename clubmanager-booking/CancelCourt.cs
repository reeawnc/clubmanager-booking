...
{
    public static class CancelCourt
    {
        [FunctionName("CancelCourt")]
            ...
            ILogger log)
        {
            ...
            using (var client = new HttpClient(handler))
            {
                try
                {
                    ...
                    /*
                     * 
                     * https://clubmanager365.com/Club/ActionHandler.ashx?siteCallback=CourtCallback&action=CancelBooking&_=1691167746990&{%22BookingID%22:8273028}
                     * https://clubmanager365.com/Club/ActionHandler.ashx?siteCallback=CourtCallback&action=CancelBooking&_=1691167746990&{"BookingID":8273028}
                     * 
                     /payload
