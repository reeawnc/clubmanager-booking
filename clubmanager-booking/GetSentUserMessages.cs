...
{
    public static class GetSentUserMessages
    {
        [FunctionName("GetSentUserMessages")]
            ...
            ILogger log)
        {
            ...
            using (var client = new HttpClient(handler))
            {
                ...
                {                    
                    ...
                    ////https://clubmanager365.com/Club/ActionHandler.ashx?siteCallback=MemberCallback&action=GetSentUserMessages&_=1692550094758&{}
